...
english_fixes = {
	...
	re.compile(r"\b(\w+'{1,}[bcdfghjklmnpqrstvwxz])(h+[he]s)([abcdefghjklmnopqrstvwy]\w+)\b", re.I): r"\1 \2\3",
	re.compile(r"\b(\w+[bcdfghjklmnpqrstvwxz])('{1,}h+[he]s)([abcdefghjklmnopqrstvwy]\w+)\b", re.I): r"\1 \2\3",
	re.compile(r"\b(\w+'{1,}[bcdfghjklmnpqrstvwxz])(h+[he]s)(iron+[degins]?)", re.I): r"\1 \2\3",
	re.compile(r"\b(\w+[bcdfghjklmnpqrstvwxz])('{1,}h+[he]s)(iron+[degins]?)", re.I): r"\1 \2\3",
