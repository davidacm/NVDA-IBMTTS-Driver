...
# Import appConfig from the correct settingsDB module based on NVDA architecture
import sys as _sys
if _sys.maxsize > 2**32:
	# NVDA 64-bit - use _settingsDB64
	from synthDrivers._settingsDB64 import appConfig
else:
	# NVDA 32-bit - use _settingsDB32
	from synthDrivers._settingsDB32 import appConfig
